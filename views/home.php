            ...
            <div class="page-body">
                <div class="container-xl mt-4">
                    <div class="row row-cards">
                        <div class="col-md-12">
                            <div class="card">
                                <?php $data = json_decode($jsonData); ?>
                                <div class="card-header" style="background-image: url(<?php echo asset("/{$data->image_path}") ?>);background-size: cover; background-position: center;width: 100%;height: 400px">
