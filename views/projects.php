                    ...
                    <?php 
                        ...
                        foreach ($data['projects'] as $project) {
                            ?>
                                <div class="col-md">
                                    <div class="card">
                                        <div class="card-header" style="background-image: url(<?php echo asset("/".$project['image_path']); ?>);background-size: cover; background-position: center;width: 100%;height: 300px">

                                        </div>
                                        <div class="card-body text-center">
                                            <h3 class="card-title text-center"><strong><?php echo $project['name']; ?></strong></h3>
                                            <button class="btn btn-outline-success btn-lg">
                                                <a href="/projects/<?php echo $project['id'] ?>" class="nav-link">See Details</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
